...
const AboutPage = () => {
  return (
    <section className="flex flex-col my-12 gap-20 items-center justify-center">
      <div className="flex items-start gap-7">
        <div className="flex flex-col gap-2">
          ...
          <Image
            ...
            width={300}
            height={200}
            className="rounded-b-2xl h-[160px]"
          />
        </div>
      ...
      <div className="flex items-start justify-between px-10 w-full">
        <div className="flex flex-col gap-5">
          <div className=" p-2 bg-blue-200 rounded-lg w-fit">
            <GiUpgrade className="w-9 h-9" />
          </div>
        ...
        <div className="flex items-end flex-col gap-5">
          ...
          <h1 className=" font-montserrat text-2xl">Join Us on this Journey</h1>
